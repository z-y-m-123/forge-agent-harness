...
import { loadGitHubFile, type GitHubFile } from '../domain/github-api'
...
export function WorkspacePage() {
  ...
  return <main className="workspace">
    <aside className="repo-tree">
      ...
      {files.slice(0, 8).map((file, index) => <button className={`tree-file ${file === selectedFile ? 'selected' : ''}`} type="button" onClick={() => void readFile(file)} key={file}>
